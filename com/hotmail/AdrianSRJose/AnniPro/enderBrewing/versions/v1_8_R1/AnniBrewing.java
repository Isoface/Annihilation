package com.hotmail.AdrianSRJose.AnniPro.enderBrewing.versions.v1_8_R1;

import java.util.UUID;

import org.bukkit.Bukkit;
import org.bukkit.craftbukkit.v1_8_R1.block.CraftBrewingStand;
...
class AnniBrewing extends TileEntityBrewingStand implements IBrewing {
	...
	public void load(final com.hotmail.AdrianSRJose.AnniPro.enderBrewing.api.BrewingData data) {
		...
		for (int x = 0; x < 4; x++)
			setItem(x, org.bukkit.craftbukkit.v1_8_R1.inventory.CraftItemStack.asNMSCopy(items[x]));
