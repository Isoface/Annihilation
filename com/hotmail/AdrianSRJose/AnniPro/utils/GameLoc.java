...
public final class GameLoc implements Cloneable {
	private Number x, y, z;
	private float pitch, yaw;
	private String world;

	public GameLoc(Location loc, boolean precise) {
	...
	public GameLoc(Location loc) {
		this(loc, false);
	}

	public GameLoc(String world, Number x, Number y, Number z) {
		this(world, x, y, z, 0, 0);
	}

	public GameLoc(String world, Number x, Number y, Number z, float pitch, float yaw) {
		this.world = world;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public GameLoc(ConfigurationSection section) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof GameLoc) {
			GameLoc l = (GameLoc) obj;
