...
public enum ChatColore {
	...
	private final static Map<Integer, ChatColore> BY_ID = Maps.newHashMap();
	private final static Map<Character, ChatColore> BY_CHAR = Maps.newHashMap();

	private ChatColore(char code, int intCode) {
		this(code, intCode, false);
	}

	private ChatColore(char code, int intCode, boolean isFormat) {
		this.code = code;
	 ...
	 *         if it doesn't exist
	 */
	public static ChatColore getByChar(char code) {
	 ...
	 *         if it doesn't exist
	 */
	public static ChatColore getByChar(String code) {
