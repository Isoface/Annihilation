...
public class PlayerInteractAtSoulboundItemEvent extends Event implements Cancellable {
	private static final HandlerList list = new HandlerList();
	private boolean cancel;
	private final AnniPlayer player;
	private final ItemStack stack;

	public PlayerInteractAtSoulboundItemEvent(AnniPlayer ap, ItemStack stack) {
		player = ap;
		this.stack = stack;
	}

	public PlayerInteractAtSoulboundItemEvent(PlayerInteractEvent event) {
